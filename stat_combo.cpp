...
void stat_combo::choix_pie()
    ...
    q2.prepare("SELECT * FROM produit WHERE etat='stock maximal'");
    q2.exec();

    q3.prepare("SELECT * FROM produit WHERE etat='épuisé'");
    q3.exec();

    q4.prepare("SELECT * FROM produit WHERE etat='presque épuisé' ");
    q4.exec();
    ...
    series->append("stock maximal",c1);
    series->append("épuisé",c2);
    series->append("presque épuisé",c3);
